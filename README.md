...
## Summary/Description
Shows dependencies for a selected Release or Milestone, depending on the selector.  

This app will respond to a Release Scoped or Milestone Scoped dashboard.  If no scope selector is on the dashboard, then
this app will render a Release selector.  

![screenshot](./images/enhanced-dependency-app.png)

This shows all stories with predecessors that are in the following dataset:
*  Are explicitly associated with the selected timebox
*  Are descendants of a Feature associated with the selected timebox
